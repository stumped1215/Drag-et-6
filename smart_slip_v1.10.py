...
# ============== UI ==============
st.title("🏁 Smart Slip")
st.caption("Bracket Racing • Formula + Grok Hybrid  •  v1.10")
...
# MANUAL LOG (with same special conditions + 330 ft)
with tab_manual:
...
st.divider()
st.caption("Smart Slip v1.10 • Formula + Grok Hybrid Intelligence • Built for bracket racers")