...
# ============== UI ==============
st.title("🏁 Smart Slip")
st.caption("Bracket Racing • Formula + Grok Hybrid  •  v1.11")
...
# IMPORT FROM GROK (with car number input + dynamic prompt)
with tab_import:
    st.subheader("Import from Grok")

    # Car number input (so the prompt can be customized)
...
st.divider()
st.caption("Smart Slip v1.11 • Formula + Grok Hybrid Intelligence • Built for bracket racers")